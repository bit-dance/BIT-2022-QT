...
#include "../QuickTalk_Client/udpreciver.h"
...
QT_MOC_LITERAL(3, 24, 13) // "readDatagrams"

    },
    "UdpReciver\0deliverInfo\0\0readDatagrams"
};
...
void UdpReciver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->deliverInfo((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->readDatagrams(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (UdpReciver::*)(QString );
...
// SIGNAL 0
void UdpReciver::deliverInfo(QString _t1)
{
